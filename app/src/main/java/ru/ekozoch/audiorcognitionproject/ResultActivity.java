...
public class ResultActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(Music music: listMusic){
            if(RecognitionActivity.timing.get(music)!=null)
                Log.e("Result", music.getSongArtist() + " - " + music.getSongName() + ": " + RecognitionActivity.timing.get(music).toString());
        }
        ...
        final String artist = listMusic.get(0).getSongArtist();
        final String song = listMusic.get(0).getSongName();
